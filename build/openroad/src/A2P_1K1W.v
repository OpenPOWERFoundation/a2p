...
module DataCache (
  ...
  wire       [21:0]   DC_DIR_tagsReadRsp_address;
  wire       [23:0]   _zz_4_;
  wire                _zz_5_;
  ...
  reg                 loader_error;
  reg [23:0] DC_DIR_tags [0:31];
  reg [7:0] DC_DIR_data_symbol0 [0:255];
  reg [7:0] DC_DIR_data_symbol1 [0:255];
  reg [7:0] DC_DIR_data_symbol2 [0:255];
  reg [7:0] DC_DIR_data_symbol3 [0:255];
  reg [7:0] _zz_23_;
  reg [7:0] _zz_24_;
  reg [7:0] _zz_25_;
  reg [7:0] _zz_26_;
  ...
  assign _zz_16_ = (stageB_mmuRsp_physicalAddress[9 : 5] != 5'h1f);
  ...
  assign DC_DIR_tagsReadRsp_address = _zz_4_[23 : 2];
  ...
  always @ (*) begin
    tagsWriteCmd_payload_data_address = 22'h0;
    if(loader_counter_willOverflow)begin
  ...
  always @ (*) begin
    dataWriteCmd_payload_address = 8'h0;
    if(io_cpu_writeBack_isValid)begin
      if(! stageB_mmuRsp_isIoAccess) begin
        if(_zz_14_)begin
  ...
  assign stage0_colisions[0] = (((dataWriteCmd_valid && dataWriteCmd_payload_way[0]) && (dataWriteCmd_payload_address == io_cpu_execute_address[9 : 2])) && ((stage0_mask & dataWriteCmd_payload_mask) != (4'b0000)));
  ...
  assign stageA_wayHits_0 = ((io_cpu_memory_mmuBus_rsp_physicalAddress[31 : 10] == DC_DIR_tagsReadRsp_address) && DC_DIR_tagsReadRsp_valid);
  assign _zz_7_[0] = (((dataWriteCmd_valid && dataWriteCmd_payload_way[0]) && (dataWriteCmd_payload_address == io_cpu_memory_address[9 : 2])) && ((stageA_mask & dataWriteCmd_payload_mask) != (4'b0000)));
  ...
  always @ (posedge clk) begin
    ...
    if(stageB_flusher_valid)begin
      if(_zz_16_)begin
        stageB_mmuRsp_physicalAddress[9 : 5] <= (stageB_mmuRsp_physicalAddress[9 : 5] + 5'h01);
      end
    end
    if(stageB_flusher_start)begin
      stageB_mmuRsp_physicalAddress[9 : 5] <= 5'h0;
    end
  end
...
module A2P_1K1W (
  ...
  assign _zz_453_ = ($signed(_zz_454_) + $signed(_zz_459_));
  assign _zz_454_ = ($signed(_zz_455_) + $signed(_zz_457_));
  assign _zz_455_ = 52'h0;
  assign _zz_456_ = {1'b0,memory_MUL_LL};
  assign _zz_457_ = {{19{_zz_456_[32]}}, _zz_456_};
  assign _zz_458_ = ({16'd0,memory_MUL_LH} <<< 16);
  assign _zz_459_ = {{2{_zz_458_[49]}}, _zz_458_};
  assign _zz_460_ = ({16'd0,memory_MUL_HL} <<< 16);
  assign _zz_461_ = {{2{_zz_460_[49]}}, _zz_460_};
  assign _zz_462_ = _zz_157_[37 : 37];
  assign _zz_463_ = _zz_157_[64 : 64];
  assign _zz_464_ = _zz_157_[75 : 75];
  assign _zz_465_ = _zz_157_[51 : 51];
  assign _zz_466_ = _zz_157_[47 : 47];
  assign _zz_467_ = _zz_157_[58 : 58];
  assign _zz_468_ = _zz_157_[5 : 5];
  assign _zz_469_ = _zz_157_[6 : 6];
  assign _zz_470_ = _zz_157_[25 : 25];
  assign _zz_471_ = _zz_157_[38 : 38];
  assign _zz_472_ = _zz_157_[50 : 50];
  assign _zz_473_ = _zz_157_[31 : 31];
  assign _zz_474_ = _zz_157_[14 : 14];
  assign _zz_475_ = _zz_157_[63 : 63];
  assign _zz_476_ = _zz_157_[60 : 60];
  assign _zz_477_ = _zz_157_[8 : 8];
  assign _zz_478_ = _zz_157_[26 : 26];
  ...
  assign _zz_494_ = _zz_157_[30 : 30];
  ...
  assign _zz_1306_ = ({_zz_1322_,_zz_1323_} != (3'b000));
  assign _zz_1307_ = 1'b0;
  assign _zz_1308_ = {_zz_1324_,{_zz_1325_,_zz_1326_}};
  assign _zz_1309_ = 32'ha0000108;
  assign _zz_1310_ = (decode_INSTRUCTION & 32'ha0000018);
  assign _zz_1311_ = 32'h20000018;
  assign _zz_1312_ = ((decode_INSTRUCTION & _zz_1327_) == 32'h20000010);
  assign _zz_1313_ = (_zz_1328_ == _zz_1329_);
  assign _zz_1314_ = {_zz_1330_,_zz_1331_};
  ...
  assign _zz_1319_ = ((decode_INSTRUCTION & _zz_1332_) == 32'h00000300);
  assign _zz_1320_ = (_zz_1333_ == _zz_1334_);
  assign _zz_1321_ = (_zz_1335_ == _zz_1336_);
  assign _zz_1322_ = _zz_194_;
  assign _zz_1323_ = {_zz_190_,_zz_1337_};
  assign _zz_1324_ = (_zz_1338_ != (1'b0));
  assign _zz_1325_ = (_zz_1339_ != _zz_1340_);
  assign _zz_1326_ = {_zz_1341_,{_zz_1342_,_zz_1343_}};
  assign _zz_1327_ = 32'ha0000012;
  assign _zz_1328_ = (decode_INSTRUCTION & 32'ha000000c);
  assign _zz_1329_ = 32'h20000000;
  assign _zz_1330_ = ((decode_INSTRUCTION & 32'ha0000218) == 32'h20000200);
  assign _zz_1331_ = ((decode_INSTRUCTION & 32'ha0000198) == 32'h20000000);
  assign _zz_1332_ = 32'h00000300;
  assign _zz_1333_ = (decode_INSTRUCTION & 32'h00000140);
  assign _zz_1334_ = 32'h00000140;
  assign _zz_1335_ = (decode_INSTRUCTION & 32'h00000240);
  assign _zz_1336_ = 32'h00000240;
  assign _zz_1337_ = ((decode_INSTRUCTION & 32'h78000132) == 32'h78000010);
  assign _zz_1338_ = ((decode_INSTRUCTION & 32'h20000200) == 32'h20000200);
  assign _zz_1339_ = ((decode_INSTRUCTION & _zz_1344_) == 32'h20000000);
  assign _zz_1340_ = (1'b0);
  assign _zz_1341_ = ({_zz_1345_,_zz_1346_} != (2'b00));
  assign _zz_1342_ = (_zz_1347_ != (1'b0));
  assign _zz_1343_ = {(_zz_1348_ != _zz_1349_),{_zz_1350_,{_zz_1351_,_zz_1352_}}};
  assign _zz_1344_ = 32'h20000200;
  assign _zz_1345_ = ((decode_INSTRUCTION & 32'h04000000) == 32'h0);
  assign _zz_1346_ = ((decode_INSTRUCTION & 32'h20000600) == 32'h20000400);
  assign _zz_1347_ = ((decode_INSTRUCTION & 32'h7800038a) == 32'h78000202);
  assign _zz_1348_ = {_zz_171_,_zz_193_};
  assign _zz_1349_ = (2'b00);
  assign _zz_1350_ = (((decode_INSTRUCTION & _zz_1353_) == 32'h4c000400) != (1'b0));
  assign _zz_1351_ = ({_zz_1354_,_zz_1355_} != (2'b00));
  assign _zz_1352_ = {({_zz_1356_,_zz_1357_} != (3'b000)),{(_zz_1358_ != _zz_1359_),{_zz_1360_,{_zz_1361_,_zz_1362_}}}};
  assign _zz_1353_ = 32'h7c000404;
  assign _zz_1354_ = ((decode_INSTRUCTION & 32'hfc000000) == 32'h40000000);
  assign _zz_1355_ = ((decode_INSTRUCTION & 32'h7c0005e0) == 32'h4c000020);
  assign _zz_1356_ = ((decode_INSTRUCTION & _zz_1363_) == 32'h48000000);
  assign _zz_1357_ = {(_zz_1364_ == _zz_1365_),(_zz_1366_ == _zz_1367_)};
  assign _zz_1358_ = {_zz_165_,{_zz_192_,{_zz_1368_,_zz_1369_}}};
  assign _zz_1359_ = 6'h0;
  assign _zz_1360_ = ({_zz_1370_,_zz_1371_} != (2'b00));
  assign _zz_1361_ = ({_zz_1372_,_zz_1373_} != (3'b000));
  assign _zz_1362_ = {(_zz_1374_ != _zz_1375_),{_zz_1376_,{_zz_1377_,_zz_1378_}}};
  assign _zz_1363_ = 32'hfc000000;
  assign _zz_1364_ = (decode_INSTRUCTION & 32'h78000046);
  assign _zz_1365_ = 32'h48000040;
  assign _zz_1366_ = (decode_INSTRUCTION & 32'h780005e0);
  assign _zz_1367_ = 32'h48000020;
  assign _zz_1368_ = (_zz_1379_ == _zz_1380_);
  assign _zz_1369_ = {_zz_191_,{_zz_1381_,_zz_1382_}};
  assign _zz_1370_ = ((decode_INSTRUCTION & _zz_1383_) == 32'h18000000);
  assign _zz_1371_ = ((decode_INSTRUCTION & _zz_1384_) == 32'h18000080);
  assign _zz_1372_ = (_zz_1385_ == _zz_1386_);
  assign _zz_1373_ = {_zz_1387_,_zz_1388_};
  assign _zz_1374_ = {_zz_1389_,{_zz_1390_,_zz_1391_}};
  assign _zz_1375_ = (3'b000);
  assign _zz_1376_ = ({_zz_1392_,_zz_1393_} != (3'b000));
  assign _zz_1377_ = (_zz_1394_ != _zz_1395_);
  assign _zz_1378_ = {_zz_1396_,{_zz_1397_,_zz_1398_}};
  assign _zz_1379_ = (decode_INSTRUCTION & 32'h40000120);
  assign _zz_1380_ = 32'h40000120;
  assign _zz_1381_ = _zz_169_;
  assign _zz_1382_ = (_zz_1399_ == _zz_1400_);
  assign _zz_1383_ = 32'h18000008;
  assign _zz_1384_ = 32'h18000280;
  assign _zz_1385_ = (decode_INSTRUCTION & 32'h18000000);
  assign _zz_1386_ = 32'h08000000;
  assign _zz_1387_ = ((decode_INSTRUCTION & _zz_1401_) == 32'h08000080);
  assign _zz_1388_ = ((decode_INSTRUCTION & _zz_1402_) == 32'h08000200);
  assign _zz_1389_ = ((decode_INSTRUCTION & _zz_1403_) == 32'h0);
  assign _zz_1390_ = (_zz_1404_ == _zz_1405_);
  assign _zz_1391_ = (_zz_1406_ == _zz_1407_);
  assign _zz_1392_ = (_zz_1408_ == _zz_1409_);
  assign _zz_1393_ = {_zz_1410_,_zz_1411_};
  assign _zz_1394_ = {_zz_176_,{_zz_1412_,_zz_1413_}};
  assign _zz_1395_ = (4'b0000);
  assign _zz_1396_ = ({_zz_1414_,_zz_1415_} != 31'h0);
  assign _zz_1397_ = (_zz_1416_ != _zz_1417_);
  assign _zz_1398_ = {_zz_1418_,{_zz_1419_,_zz_1420_}};
  assign _zz_1399_ = (decode_INSTRUCTION & 32'h40000022);
  assign _zz_1400_ = 32'h40000020;
  assign _zz_1401_ = 32'h080000c0;
  assign _zz_1402_ = 32'h08000300;
  assign _zz_1403_ = 32'h18000000;
  assign _zz_1404_ = (decode_INSTRUCTION & 32'h18000240);
  assign _zz_1405_ = 32'h18000200;
  assign _zz_1406_ = (decode_INSTRUCTION & 32'h18000500);
  assign _zz_1407_ = 32'h18000100;
  assign _zz_1408_ = (decode_INSTRUCTION & 32'h18000048);
  assign _zz_1409_ = 32'h18000040;
  assign _zz_1410_ = ((decode_INSTRUCTION & _zz_1421_) == 32'h18000100);
  assign _zz_1411_ = ((decode_INSTRUCTION & _zz_1422_) == 32'h18000040);
  assign _zz_1412_ = (_zz_1423_ == _zz_1424_);
  assign _zz_1413_ = {_zz_190_,_zz_1425_};
  assign _zz_1414_ = (_zz_1426_ == _zz_1427_);
  assign _zz_1415_ = {_zz_1428_,{_zz_1429_,_zz_1430_}};
  assign _zz_1416_ = {_zz_170_,_zz_1431_};
  assign _zz_1417_ = (2'b00);
  assign _zz_1418_ = ({_zz_1432_,_zz_1433_} != 5'h0);
  assign _zz_1419_ = (_zz_1434_ != _zz_1435_);
  assign _zz_1420_ = {_zz_1436_,{_zz_1437_,_zz_1438_}};
  assign _zz_1421_ = 32'h18000540;
  assign _zz_1422_ = 32'h180002c0;
  assign _zz_1423_ = (decode_INSTRUCTION & 32'h7800020c);
  assign _zz_1424_ = 32'h78000200;
  assign _zz_1425_ = ((decode_INSTRUCTION & _zz_1439_) == 32'h78000010);
  assign _zz_1426_ = (decode_INSTRUCTION & 32'hc0100000);
  assign _zz_1427_ = 32'h00100000;
  assign _zz_1428_ = ((decode_INSTRUCTION & _zz_1440_) == 32'h00100000);
  assign _zz_1429_ = _zz_189_;
  assign _zz_1430_ = {_zz_188_,{_zz_1441_,_zz_1442_}};
  assign _zz_1431_ = ((decode_INSTRUCTION & _zz_1443_) == 32'h78000060);
  assign _zz_1432_ = (_zz_1444_ == _zz_1445_);
  assign _zz_1433_ = {_zz_1446_,{_zz_1447_,_zz_1448_}};
  assign _zz_1434_ = {_zz_1449_,{_zz_1450_,_zz_1451_}};
  assign _zz_1435_ = (4'b0000);
  assign _zz_1436_ = ({_zz_1452_,_zz_1453_} != (2'b00));
  assign _zz_1437_ = (_zz_1454_ != _zz_1455_);
  assign _zz_1438_ = {_zz_1456_,{_zz_1457_,_zz_1458_}};
  assign _zz_1439_ = 32'h78000272;
  assign _zz_1440_ = 32'h44100000;
  assign _zz_1441_ = (_zz_1459_ == _zz_1460_);
  assign _zz_1442_ = {_zz_187_,{_zz_1461_,_zz_1462_}};
  assign _zz_1443_ = 32'h78000170;
  assign _zz_1444_ = (decode_INSTRUCTION & 32'hb0000000);
  assign _zz_1445_ = 32'h10000000;
  assign _zz_1446_ = ((decode_INSTRUCTION & _zz_1463_) == 32'h58000200);
  assign _zz_1447_ = (_zz_1464_ == _zz_1465_);
  assign _zz_1448_ = {_zz_1466_,_zz_1467_};
  assign _zz_1449_ = ((decode_INSTRUCTION & _zz_1468_) == 32'h60000000);
  assign _zz_1450_ = _zz_169_;
  assign _zz_1451_ = {_zz_1469_,_zz_1470_};
  assign _zz_1452_ = _zz_168_;
  assign _zz_1453_ = (_zz_1471_ == _zz_1472_);
  assign _zz_1454_ = {_zz_1473_,{_zz_1474_,_zz_1475_}};
  assign _zz_1455_ = (4'b0000);
  assign _zz_1456_ = ({_zz_1476_,_zz_1477_} != (3'b000));
  assign _zz_1457_ = (_zz_1478_ != _zz_1479_);
  assign _zz_1458_ = {_zz_1480_,{_zz_1481_,_zz_1482_}};
  assign _zz_1459_ = (decode_INSTRUCTION & 32'hec000000);
  assign _zz_1460_ = 32'h0c000000;
  assign _zz_1461_ = _zz_186_;
  assign _zz_1462_ = {_zz_185_,{_zz_1483_,_zz_1484_}};
  assign _zz_1463_ = 32'h5800020c;
  assign _zz_1464_ = (decode_INSTRUCTION & 32'h58000228);
  assign _zz_1465_ = 32'h58000020;
  assign _zz_1466_ = ((decode_INSTRUCTION & _zz_1485_) == 32'h580002c0);
  assign _zz_1467_ = ((decode_INSTRUCTION & _zz_1486_) == 32'h58000020);
  assign _zz_1468_ = 32'h68000000;
  assign _zz_1469_ = ((decode_INSTRUCTION & _zz_1487_) == 32'h60000008);
  assign _zz_1470_ = ((decode_INSTRUCTION & _zz_1488_) == 32'h60000024);
  assign _zz_1471_ = (decode_INSTRUCTION & 32'h80000280);
  assign _zz_1472_ = 32'h0;
  assign _zz_1473_ = ((decode_INSTRUCTION & _zz_1489_) == 32'h0);
  assign _zz_1474_ = (_zz_1490_ == _zz_1491_);
  assign _zz_1475_ = {_zz_1492_,_zz_1493_};
  assign _zz_1476_ = _zz_167_;
  assign _zz_1477_ = {_zz_161_,_zz_166_};
  assign _zz_1478_ = {_zz_165_,{_zz_1494_,_zz_1495_}};
  assign _zz_1479_ = 10'h0;
  assign _zz_1480_ = (_zz_1496_ != (1'b0));
  assign _zz_1481_ = (_zz_1497_ != _zz_1498_);
  assign _zz_1482_ = {_zz_1499_,{_zz_1500_,_zz_1501_}};
  assign _zz_1483_ = _zz_184_;
  assign _zz_1484_ = {_zz_183_,{_zz_1502_,_zz_1503_}};
  assign _zz_1485_ = 32'h580002c4;
  assign _zz_1486_ = 32'h5800042a;
  assign _zz_1487_ = 32'h6000000c;
  assign _zz_1488_ = 32'h6000002c;
  assign _zz_1489_ = 32'h08000000;
  assign _zz_1490_ = (decode_INSTRUCTION & 32'h80000200);
  assign _zz_1491_ = 32'h00000200;
  assign _zz_1492_ = ((decode_INSTRUCTION & _zz_1504_) == 32'h20000000);
  assign _zz_1493_ = ((decode_INSTRUCTION & _zz_1505_) == 32'h0);
  assign _zz_1494_ = (_zz_1506_ == _zz_1507_);
  assign _zz_1495_ = {_zz_1508_,{_zz_1509_,_zz_1510_}};
  assign _zz_1496_ = ((decode_INSTRUCTION & _zz_1511_) == 32'h78000200);
  assign _zz_1497_ = {_zz_163_,_zz_162_};
  assign _zz_1498_ = (2'b00);
  assign _zz_1499_ = (_zz_161_ != (1'b0));
  assign _zz_1500_ = (_zz_1512_ != _zz_1513_);
  assign _zz_1501_ = {_zz_1514_,{_zz_1515_,_zz_1516_}};
  assign _zz_1502_ = _zz_182_;
  assign _zz_1503_ = {_zz_181_,{_zz_1517_,_zz_1518_}};
  assign _zz_1504_ = 32'h60000000;
  assign _zz_1505_ = 32'h80000080;
  assign _zz_1506_ = (decode_INSTRUCTION & 32'h40000002);
  assign _zz_1507_ = 32'h40000000;
  assign _zz_1508_ = ((decode_INSTRUCTION & _zz_1519_) == 32'h40000000);
  assign _zz_1509_ = (_zz_1520_ == _zz_1521_);
  assign _zz_1510_ = {_zz_1522_,{_zz_1523_,_zz_1524_}};
  assign _zz_1511_ = 32'h78000212;
  assign _zz_1512_ = {_zz_1525_,_zz_1526_};
  assign _zz_1513_ = (2'b00);
  assign _zz_1514_ = ({_zz_1527_,_zz_1528_} != 6'h0);
  assign _zz_1515_ = (_zz_1529_ != _zz_1530_);
  assign _zz_1516_ = {_zz_1531_,_zz_1532_};
  assign _zz_1517_ = _zz_180_;
  assign _zz_1518_ = {_zz_179_,{_zz_1533_,_zz_1534_}};
  assign _zz_1519_ = 32'h60000000;
  assign _zz_1520_ = (decode_INSTRUCTION & 32'h18000000);
  assign _zz_1521_ = 32'h10000000;
  assign _zz_1522_ = ((decode_INSTRUCTION & _zz_1535_) == 32'h0);
  assign _zz_1523_ = (_zz_1536_ == _zz_1537_);
  assign _zz_1524_ = {_zz_1538_,{_zz_1539_,_zz_1540_}};
  assign _zz_1525_ = ((decode_INSTRUCTION & _zz_1541_) == 32'h0);
  assign _zz_1526_ = ((decode_INSTRUCTION & _zz_1542_) == 32'h40000010);
  assign _zz_1527_ = _zz_160_;
  assign _zz_1528_ = {_zz_1543_,{_zz_1544_,_zz_1545_}};
  assign _zz_1529_ = (_zz_1546_ == _zz_1547_);
  assign _zz_1530_ = (1'b0);
  assign _zz_1531_ = (_zz_1548_ != (1'b0));
  assign _zz_1532_ = ({_zz_1549_,_zz_1550_} != (3'b000));
  assign _zz_1533_ = _zz_178_;
  assign _zz_1534_ = {_zz_1551_,{_zz_1552_,_zz_1553_}};
  assign _zz_1535_ = 32'h90000000;
  assign _zz_1536_ = (decode_INSTRUCTION & 32'h40000028);
  assign _zz_1537_ = 32'h40000008;
  assign _zz_1538_ = ((decode_INSTRUCTION & _zz_1554_) == 32'h40000100);
  assign _zz_1539_ = (_zz_1555_ == _zz_1556_);
  assign _zz_1540_ = {_zz_164_,_zz_1557_};
  assign _zz_1541_ = 32'h98000000;
  assign _zz_1542_ = 32'h40000134;
  assign _zz_1543_ = ((decode_INSTRUCTION & _zz_1558_) == 32'h40000020);
  assign _zz_1544_ = (_zz_1559_ == _zz_1560_);
  assign _zz_1545_ = {_zz_159_,{_zz_1561_,_zz_1562_}};
  assign _zz_1546_ = (decode_INSTRUCTION & 32'h00000100);
  assign _zz_1547_ = 32'h00000100;
  assign _zz_1548_ = ((decode_INSTRUCTION & _zz_1563_) == 32'h00000080);
  assign _zz_1549_ = (_zz_1564_ == _zz_1565_);
  assign _zz_1550_ = {_zz_158_,_zz_1566_};
  assign _zz_1551_ = ((decode_INSTRUCTION & 32'hf8000000) == 32'h30000000);
  assign _zz_1552_ = _zz_177_;
  assign _zz_1553_ = {_zz_176_,{((decode_INSTRUCTION & _zz_1567_) == 32'h78000010),{_zz_175_,{_zz_174_,{_zz_1568_,_zz_1569_}}}}};
  assign _zz_1554_ = 32'h40000110;
  assign _zz_1555_ = (decode_INSTRUCTION & 32'h40000220);
  assign _zz_1556_ = 32'h40000200;
  assign _zz_1557_ = ((decode_INSTRUCTION & 32'h40000018) == 32'h40000000);
  assign _zz_1558_ = 32'h40000020;
  assign _zz_1559_ = (decode_INSTRUCTION & 32'h40000010);
  assign _zz_1560_ = 32'h40000000;
  assign _zz_1561_ = ((decode_INSTRUCTION & 32'h48000000) == 32'h08000000);
  assign _zz_1562_ = ((decode_INSTRUCTION & 32'h40000104) == 32'h40000004);
  assign _zz_1563_ = 32'h00000180;
  assign _zz_1564_ = (decode_INSTRUCTION & 32'h00000400);
  assign _zz_1565_ = 32'h00000400;
  assign _zz_1566_ = ((decode_INSTRUCTION & 32'h00000300) == 32'h00000200);
  assign _zz_1567_ = 32'h78000030;
  assign _zz_1568_ = _zz_173_;
  assign _zz_1569_ = {_zz_172_,{((decode_INSTRUCTION & 32'h78000188) == 32'h78000180),{_zz_171_,{((decode_INSTRUCTION & 32'h38100458) == 32'h38100008),{((decode_INSTRUCTION & _zz_1570_) == 32'h78000000),{(_zz_1571_ == _zz_1572_),{_zz_1573_,{_zz_1574_,_zz_1575_}}}}}}}};
  assign _zz_1570_ = 32'h78000524;
  assign _zz_1571_ = (decode_INSTRUCTION & 32'h38010478);
  assign _zz_1572_ = 32'h38010028;
  assign _zz_1573_ = ((decode_INSTRUCTION & 32'h38020478) == 32'h38020028);
  assign _zz_1574_ = ((decode_INSTRUCTION & 32'h38080478) == 32'h38080028);
  assign _zz_1575_ = ((decode_INSTRUCTION & 32'h38040478) == 32'h38040028);
  assign _zz_1576_ = 11'h008;
  assign _zz_1577_ = 11'h009;
  assign _zz_1578_ = {{{{{{6'h0,MSR_VEC},(1'b0)},MSR_VSX},7'h0},MSR_EE},MSR_PR};
  assign _zz_1579_ = MSR_FP;
  assign _zz_1580_ = {{{{{{6'h0,MSR_VEC},(1'b0)},MSR_VSX},7'h0},MSR_EE},MSR_PR};
  assign _zz_1581_ = MSR_FP;
  assign _zz_1582_ = {{{{{{6'h0,MSR_VEC},(1'b0)},MSR_VSX},7'h02},MSR_EE},MSR_PR};
  ...
  assign memory_MUL_LOW = ($signed(_zz_453_) + $signed(_zz_461_));
  assign decode_DECODER_stageables_23 = _zz_462_[0];
  assign memory_SRC_ADD = execute_to_memory_SRC_ADD;
  assign decode_DECODER_stageables_46 = _zz_463_[0];
  ...
  assign decode_DECODER_stageables_53 = _zz_464_[0];
  assign execute_MUL_LH = ($signed(MUL1_aSLow) * $signed(MUL1_bHigh));
  assign decode_DECODER_stageables_35 = _zz_465_[0];
  assign execute_DECODER_stageables_31 = decode_to_execute_DECODER_stageables_31;
  assign decode_DECODER_stageables_31 = _zz_466_[0];
  assign execute_CR_FIELD_WR = _zz_75_;
  assign memory_SRC1 = execute_to_memory_SRC1;
  assign decode_DECODER_stageables_40 = _zz_467_[0];
  assign decode_DECODER_stageables_2 = _zz_468_[0];
  assign decode_DECODER_stageables_3 = _zz_469_[0];
  assign decode_DECODER_stageables_15 = _zz_470_[0];
  ...
  assign decode_DECODER_stageables_24 = _zz_471_[0];
  assign decode_DECODER_stageables_34 = _zz_472_[0];
  ...
  assign decode_DECODER_stageables_19 = _zz_473_[0];
  assign execute_BRANCH_DO = _zz_334_;
  assign decode_DECODER_stageables_9 = _zz_474_[0];
  assign decode_DECODER_stageables_45 = _zz_475_[0];
  assign decode_DECODER_stageables_42 = _zz_476_[0];
  ...
  assign decode_DECODER_stageables_16 = _zz_478_[0];
  ...
  assign decode_DECODER_stageables_18 = _zz_494_[0];
  ...
  assign _zz_1584_ = zz_SPRPlugin_selfException_payload_imm(1'b0);
  always @ (*) SPRPlugin_selfException_payload_imm = _zz_1584_;
  always @ (*) begin
  ...
  always @ (posedge clk) begin
    ...
    if(_zz_408_)begin
      ...
      SPRPlugin_srr1 <= {{{{{{{{{{{{_zz_1578_,_zz_1579_},MSR_ME},MSR_FE0},(2'b00)},MSR_FE1},(2'b00)},MSR_IR},MSR_DR},(1'b0)},MSR_PMM},MSR_RI},MSR_LE};
    ...
    if(_zz_410_)begin
      ...
      SPRPlugin_srr1 <= {{{{{{{{{{{{_zz_1580_,_zz_1581_},MSR_ME},MSR_FE0},(2'b00)},MSR_FE1},(2'b00)},MSR_IR},MSR_DR},(1'b0)},MSR_PMM},MSR_RI},MSR_LE};
    end
    if(_zz_411_)begin
      SPRPlugin_srr0 <= (writeBack_PC + 32'h00000004);
