...
module InstructionCache (
  ...
  */
  ...
  always @ (posedge clk) begin
    if(_zz_6_) begin
//wtf      _zz_11_ <= ways_0_tags[_zz_5_];
      _zz_11_ <= dir_rd_dat;
    end
  end
...
*/
  ...
  always @ (posedge clk) begin
    if(_zz_5_) begin
      ...
      _zz_23_ <= dcdata_rd_dat[7:0];
      _zz_24_ <= dcdata_rd_dat[15:8];
      _zz_25_ <= dcdata_rd_dat[23:16];
      _zz_26_ <= dcdata_rd_dat[31:24];
    end
  end
  ...
  */
  assign dcdata_we = dataWriteCmd_payload_mask & {_zz_1_,_zz_1_,_zz_1_,_zz_1_};
...
module A2P_WB (
  ...
  always @ (posedge clk) begin
    if(_zz_659_) begin
      _zz_390_ <= RegFilePlugin_regFileReadData1; // RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress1];
    end
  end

  always @ (posedge clk) begin
    if(_zz_660_) begin
      _zz_391_ <= RegFilePlugin_regFileReadData2; // RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress2];
    end
  end

  always @ (posedge clk) begin
    if(_zz_661_) begin
      _zz_392_ <= RegFilePlugin_regFileReadData1; // RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress3];
    end
  end
